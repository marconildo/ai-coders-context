...
export {
  ...
  DEFAULT_HOOK_TRACE_MAX_BYTES,
  DEFAULT_TRACE_EVENT_MAX_BYTES,
  DEFAULT_TRACE_ROTATION_BYTES,
  DEFAULT_TRACE_RETAINED_SEGMENTS,
  DEFAULT_SESSION_TRACE_MAX_BYTES,
  classifyBashCommand,
  extractBashCommand,
  ...
  type HookTraceMetrics,
  type SanitizedHookTraceData,
  ...
  type HarnessTracePageQuery,
  type HarnessSensorSummary,
  ...
  type RuntimePruneReport,
  type RuntimePruneOptions,
