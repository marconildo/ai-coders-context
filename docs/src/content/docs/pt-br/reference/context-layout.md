...
| `.context/config/runtime.json` | versioned | Sim | Limites versionados de retenção para traces, sessions, replays, datasets, checkpoints, bindings e caches. Valores inseguros são limitados por tetos absolutos. |
